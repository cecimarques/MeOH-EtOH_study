...
Inside the directory **Python_codes** you can find all (evidently, python) codes written in-house that were used in the post-processing of simulation files aiming to get results. These are Hbond_lifetime_ME.py, (xxx).
